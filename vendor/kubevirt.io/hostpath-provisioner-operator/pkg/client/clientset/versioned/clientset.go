...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.hostpathprovisionerV1alpha1, err = hostpathprovisionerv1alpha1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
	cs.hostpathprovisionerV1beta1, err = hostpathprovisionerv1beta1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	var cs Clientset
	cs.hostpathprovisionerV1alpha1 = hostpathprovisionerv1alpha1.NewForConfigOrDie(c)
	cs.hostpathprovisionerV1beta1 = hostpathprovisionerv1beta1.NewForConfigOrDie(c)
